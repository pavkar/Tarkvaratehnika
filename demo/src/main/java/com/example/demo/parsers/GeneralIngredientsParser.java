...
public class GeneralIngredientsParser {
    ...
    public String getIngredientsAsJson(List<String> words) throws JSONException {
        return new JSONObject().put(words.get(2), new JSONObject().put("amount", Double.parseDouble(words.get(0)))
                .put("unit", words.get(1))).toString();
    }
    ...
    public String getIngredients(List<String> getUnParsedIngreds) throws JSONException {
        ...
        for (String ingredient : getUnParsedIngreds) {
            ...
            if (Character.isDigit(ingredient.substring(0, 1).toCharArray()[0])) {
                ...
                ingredData.add("1");
                ingredData.add("NU");
                ingredData.add(ingredient);
            }
        }
        return getIngredientsAsJson(ingredData);
    }
